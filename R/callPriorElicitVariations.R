...
#' prior elicitation function (e.g.,`elicitEdgeProbLite`, or `elicitEdgeProb`)
...
#'
#' @param target_fun A function used for prior elicitation, such as
#'   `elicitEdgeProbLite`, or `elicitEdgeProb`.
...
callPriorElicitVariations <- function(
    target_fun,      # e.g.  elicitEdgeProb, elicitEdgeProbLite…
